...
class Example:
    ...
    def __init__(
        ...
        common_params = {
            "pos": wp.vec3(0,0.1*self.sim_height/2,2.0),#middle drop don't mess with the position (0,0,4.0) to generate in top
            "rot": wp.quat_from_axis_angle(wp.vec3(1.0, 0.0, 0.1), wp.pi/2), #wp.pi*0), for flat
